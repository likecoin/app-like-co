...
export default class ProgressIndicator extends Vue {
  ...
  get animatedProps() {
    ...
    return [
      ...
      },
      {
        animate: {
          attributeName: 'width',
          values: `${progress.maxWidth + progress.offset };${progress.minWidth + progress.offset}`,
          dur: '4s',
          repeatCount: 'indefinite',
        },
        transform: {
  ...
  get progressWidth() {
    return this.normalizedProgress * this.measurement.width + this.measurement.height
  }
