...
export default class Label extends Vue {
  ...
  @Prop({ default: LabelType.P5 }) readonly preset!: LabelType;

  // Horizontal align of children
  @Prop({ default: LabelAlign.Left }) readonly align!: LabelAlign

  // Vertical align of children
  @Prop({ default: LabelValign.Middle }) readonly valign!: LabelValign
